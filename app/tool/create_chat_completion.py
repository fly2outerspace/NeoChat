...
class CreateChatCompletion(BaseTool):
    name: str = ToolName.CREATE_CHAT_COMPLETION
    description: str = (
        "Use this tool to send your response to the user. "
        "When you need to reply to the user's question or provide information, "
        "call this tool with the 'response' parameter containing your answer. "
        "This is the primary way to communicate with the user."
    )
